                ...
                <div class="row mb-n6">
                    <div class="col-lg-3 col-sm-6 mb-6">
                        ...
                        <div class="footer-widget-single-item footer-widget-color--golden" data-aos="fade-up"
                            ...
                            <ul class="footer-nav">
                                <li><a href="#">Informações sobre Eventos</a></li>
                    ...
                    <div class="col-lg-3 col-sm-6 mb-6">
                        ...
                        <div class="footer-widget-single-item footer-widget-color--golden" data-aos="fade-up"
                            ...
                            <ul class="footer-nav">
                                <li><a href="#">Shows Musicais</a></li>
                                <li><a href="#">Eventos Esportivos</a></li>
                                <li><a href="#">Espetáculos Teatrais</a></li>
                    ...
                    <div class="col-lg-3 col-sm-6 mb-6">
                        ...
                        <div class="footer-widget-single-item footer-widget-color--golden" data-aos="fade-up"
                            ...
                            <div class="footer-about">
                                <p>Somos uma equipe apaixonada por proporcionar a melhor experiência de compra de
                ...
                <div class="row mb-n6">
                    ...
                    <div class="col-xl-7 col-lg-6 col-md-6 mb-6">
                        <div class="footer-newsletter" data-aos="fade-up" data-aos-delay="200">
                            <h4 class="title">FIQUE ATUALIZADO</h4>
                ...
                <div
                    ...
                    <div class="col-auto mb-6">
                        <div class="footer-copyright">
                            <p class="copyright-text">&copy; 2023 <a href="index.html">VendisqueIngressos</a>. Feito por <a href="https://github.com/Lopeszz/"
                                target="_blank">Lopes</a>
                            </p>
                        </div>
                    </div>
                    <div class="col-auto mb-6">
